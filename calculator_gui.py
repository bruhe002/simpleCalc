...
# row 0
clearBtn = Button(rootWindow, text='C', font='18', bg='#CC3E3E', padx=29, pady=30).grid(row=0, column=0)
...
# row 5
signBtn = Button(rootWindow, text="+ / -", font='30', padx=150, pady=20, bg='#D3D3D3').grid(row=5, column=0, columnspan=4)
